...
<head>
    ...
    <script>
        ...
        $(function () {
            ...
            $("#createStage").change(function () {
                var stage = $("#createStage").val()
...
<form action="workbench/transaction/save.do" id="tranForm"  method="post"  class="form-horizontal" role="form" style="position: relative; top: -30px;">
    ...
    <div class="form-group">
        ...
        <label for="create-expectedClosingDate" class="col-sm-2 control-label time1">预计成交日期<span
                style="font-size: 15px; color: red;">*</span></label>
        <div class="col-sm-10" style="width: 300px;">
    ...
    <div class="form-group">
        ...
        <label for="create-transactionStage" class="col-sm-2 control-label">阶段<span
                style="font-size: 15px; color: red;">*</span></label>
        <div class="col-sm-10" style="width: 300px;">
            <select class="form-control" id="createStage" name="stage">
                <%--			  	<option></option>--%>
                <%--			  	<option>资质审查</option>--%>
                <%--			  	<option>需求分析</option>--%>
                <%--			  	<option>价值建议</option>--%>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            <select class="form-control" id="create-transactionType" name="type">
                ...
                <%--                <option>已有业务</option>--%>
                <%--                <option>新业务</option>--%>
                <c:forEach items="${requestScope.transactionTypeList}" var="t">
