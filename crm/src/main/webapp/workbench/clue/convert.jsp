...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            //为提交按钮【市场活动】绑定事件 填写 市场活动源
            $("#submitActivityBtn").click(function () {
                //取得市场活动中的id
                var id = $("input[name=zx]:checked").val();
                //取得市场活动中的name
				var name = $("#"+id).html()
				//将以上信息填写到交易表单的市场活动中
    ...
    <div class="modal-dialog" role="document" style="width: 90%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="submitActivityBtn" class="btn btn-primary">提交</button>
            </div>
        </div>
    </div>
</div>
